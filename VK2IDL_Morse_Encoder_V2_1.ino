 ...
 * Version 2.1 fixex a bug that cause LF and CR characters from the keyboard to be included 
 * in the morse buffer causing an exits morse 1 to be sent after text.
 * 
...
String verNum = "2.1";        // ========== Version number ==============
...
void getTX_Characters()
{
  ...
  { 
    ...
    else if((int(inputChar) == 13)             // ignore CR
      | (int(inputChar) == 10))                // Ignore LF
